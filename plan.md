...
- **N3 — Lifting a divergent integral simultaneously.** Lifting uses the (n+1)-dim fan; divergence handling uses the n-dim fan. They are kept as **mutually exclusive** per-call paths in v3 (a sector is plain-convergent, or divergent, or lifted — not lifted *and* divergent). Combining them is documented future work.
...
"Lift"          -> None        (* None | Automatic | <lift-rules>; mutually exclusive with divergence *)
...
**D3 — Lifting and divergence are mutually exclusive per call (N3).** Different fans, never combined in v3. *Recommended.*
...
| 8 | **Lift ≠ Diverge** (N3) | Mutually exclusive paths; document combining as future work. |
