...
\texttt{"LiftData"} & \texttt{None} & Association from \texttt{LiftCoefficients[]} or \texttt{None}; advanced/low-level path (typical users call \texttt{EvaluateTropicalMCLifted}); mutually exclusive with divergence \\
